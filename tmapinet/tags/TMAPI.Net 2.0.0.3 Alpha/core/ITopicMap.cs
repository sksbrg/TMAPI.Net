...
namespace org.tmapi.core {
	...
	public interface ITopicMap : IReifiable {
        #region Properties
		/// <summary>
        ///     Returns all <see cref="T:org.tmapi.core.ITopic"/>s contained in this topic map.
	    ///     The return value may be empty but must never be <c>null</c>.
	    /// </summary>
	    /// <returns>
        ///     An unmodifiable set of <see cref="T:org.tmapi.core.ITopic"/>s.
	    /// </returns>
        ReadOnlyCollection<ITopic> Topics { get; }

        /// <summary>
        ///     Returns all <see cref="T:org.tmapi.core.IAssociation"/>s contained in this topic map.
        ///     The return value may be empty but must never be <c>null</c>.
	    /// </summary>
	    /// <returns>
        ///     An unmodifiable set of <see cref="T:org.tmapi.core.IAssociation"/>s.
	    /// </returns>
        ReadOnlyCollection<IAssociation> Associations { get; }

        /// <summary>
	    ///     Returns <c>null</c> since topic maps do not have a parent.
	    /// </summary>
	    /// <returns>
        ///     <c>null</c> since topic maps do not have a parent.
	    /// </returns>
	    new IConstruct Parent { get; }
	    #endregion
