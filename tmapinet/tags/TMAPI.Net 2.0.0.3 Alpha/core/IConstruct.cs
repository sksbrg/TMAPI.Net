...
namespace org.tmapi.core
{
    ...
    public interface IConstruct
    {
        ...
        /// </returns>
        ReadOnlyCollection<ILocator> ItemIdentifiers { get; }
        ...
        /// </returns>
        IConstruct Parent { get; }

        /// <summary>
        ///     Returns the <see cref="T:org.tmapi.core.ITopicMap"/> instance to which this Topic Maps construct
        ///     belongs.
